					...
					<div class="settings-card">
						<div class="setting-item">
							...
							<div class="theme-choices">
								<div class="theme-card" id="theme-dark-btn">Dark</div>
								<div class="theme-card" id="theme-light-btn">Light</div>
								<div class="theme-card" id="theme-system-btn">System</div>
							</div>

							<label id="label-live-theme" style="margin-top: 20px; display: block;">Live Themes</label>
							<div class="theme-choices">
								<div class="theme-card" id="theme-black-hole-btn">Black Hole</div>
								<div class="theme-card" id="theme-nullscapes-btn">Nullscapes</div>
								<div class="theme-card" id="theme-kocmoc-btn" style="display: flex; align-items: center; gap: 8px; justify-content: center;">
						...
						<div class="setting-item">
							...
							<div class="accent-choices" style="display: flex; gap: 10px; margin-top: 10px;">
								...
								<div class="accent-color-btn" data-color="#808080" data-rgb="128, 128, 128"
									id="accent-gray-btn" style="background: #808080;"></div>
